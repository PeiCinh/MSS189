...
//                mplew.writeShort(oned.unktype);
                mplew.writeShort(0);
                if (attackInfo.skill == 42111002) {
                    mplew.write(oned.attack.size());
        ...
        if (attackInfo.skill == 11121052 || attackInfo.skill == 12121054) {
            mplew.writeInt(0);
    ...
    public static byte[] dropItemFromMapObject(MapleMapItem drop, Point dropfrom, Point dropto, byte mod) {
        ...
        mplew.writeInt(0);
        mplew.writeInt(0/*Randomizer.nextInt(255)*/);
        mplew.writeInt(0);
