        ...
        if (jobSelect == -1) {
            ...
            if (jobSelect == 0) {
                ...
                if (gender == 0) {
                    ...
                    ms.equip(1050249); //1050249 - 惡魔經典套裝
                    ms.equip(1070029); //1070029 - 惡魔經典鞋
                } else {
                    ms.unequip(1051236, true); //1051236 - 黑暗惡魔套裝
                    ms.unequip(1072518, true); //1072518 - 黑暗惡魔鞋子
                    ms.equip(1051305); //1050249 - 惡魔經典禮服
                    ms.equip(1071046); //1070029 - 惡魔經典長靴
                }
                ms.equip(1102505); //1102505 - 惡魔經典披肩
                //STR 4
                //DEX 4
                ...
                ms.equip(1232001); //1232001 - 藍色復仇者
                ...
                ms.equip(1322122); //1322122 - 不幸的復仇
                ms.changeJob(3100);
