...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        ms.getDirectionEffect(2, "Effect/Direction6.img/effect/tuto/arkyrimAttack", [0, 0, -7, 1, 1, 0, 0, 2159309]);
        ms.exceTime(2010);
    } else if (status == 3) {
        ...
        ms.getDirectionEffect(2, "Effect/Direction6.img/effect/tuto/balloonMsg1/4", [1000, 0, -150, 1, 1, 0, 0, 2159309]);
        ...
        ms.getDirectionEffect(2, "Effect/Direction6.img/effect/tuto/balloonMsg1/10", [2000, 0, -150, 1, 1, 0, 0, 2159309]);
        ms.exceTime(1500);
    } else if (status == 9) {
        ...
        ms.getDirectionEffect(2, "Effect/Direction6.img/effect/tuto/balloonMsg0/0", [2000, 0, -150, 1, 1, 0, 0, 2159309]);
        ms.exceTime(1200);
    } else if (status == 13) {
